...
<body class="font-sans antialiased bg-white text-gray-900">
    ...
    <a href="https://wa.me/{{ preg_replace('/\D/', '', $whatsappNumber ?? config('services.whatsapp.number') ?? '254700000000') }}" target="_blank" rel="noopener noreferrer" class="fixed bottom-4 sm:bottom-6 left-4 sm:left-6 z-[9999] flex items-center space-x-2 bg-green-500 text-white pl-3 pr-4 py-2.5 sm:py-3 rounded-full shadow-2xl hover:bg-green-600 transition-all duration-300 hover:scale-105" style="display:flex!important">
