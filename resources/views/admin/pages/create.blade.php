...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 class="text-lg font-semibold mb-4">New Page</h2>
        <form action="{{ route('admin.pages.store') }}" method="POST" class="space-y-4">
            ...
            <button type="submit" class="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700">Create Page</button>
        </form>
    </div>
</div>
@endsection
