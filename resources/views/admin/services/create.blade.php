...
<div class="w-full space-y-6">
    ...
    <div class="bg-gradient-to-r from-gray-900 via-gray-800 to-red-900 rounded-2xl p-6 lg:p-8 relative overflow-hidden">
        ...
        <div class="relative flex items-center space-x-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-white">New Service</h2>
                <p class="text-gray-400 text-sm mt-0.5">Add a new coaching or therapy service</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all" placeholder="e.g. Individual Counselling">
                </div>
                <div class="space-y-2">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="5" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all" placeholder="Full service description..."></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="duration_minutes" min="15" step="15" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all" placeholder="e.g. 60">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="highlights" placeholder='["Benefit 1", "Benefit 2"]' class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all">
            </div>
                ...
                <div class="space-y-2">
                    ...
                    <label class="relative cursor-pointer block">
                        <div class="flex items-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all">
                            ...
                            <span class="text-sm text-gray-600">Choose icon</span>
                        </div>
